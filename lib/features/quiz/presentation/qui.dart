...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void calculateResult() {
    ...
    AwesomeDialog(context1:context, correct: correct, widget: widget);
  }
          ...
          children: [
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          isSelected ? AppColors.mainTealColor : Colors.grey[200],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text("${currentIndex+1}  /  10",style: TextThemes.font22BlackMedium.copyWith(color:   currentIndex == widget.questions.length - 1
                      ? AppColors.mainTealColor:Colors.red),),
                        ...
                        child: ElevatedButton(
                          ...
                          currentIndex > 0
                            ...
                            setState(() {
                              ...
                              : null,
                          child: Text('Previous',style: TextStyle(color:currentIndex > 0
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            currentIndex == widget.questions.length - 1
                                ? 'Finish'
                                : 'Next',style: TextStyle(color:  selectedIndex != null
                              ?Colors.white:Colors.grey),
                          ),
                        ),
                      ),
